...
class MethodChannelWebviewWinFloating extends WebviewWinFloatingPlatform {
  ...
  void initMethodCallHandler() {
    methodChannel.setMethodCallHandler((call) async {
      ...
      if (call.method == "OnWebMessageReceived") {
        ...
        controller.notifyRawWebMessage_(jobj);
        if (jobj is Map && jobj.containsKey("JkChannelName")) {
      ...
      } else if (call.method == "onProcessFailed") {
        controller.notifyOnProcessFailed_(call.arguments["kind"] as int);
  ...
  Future<bool> create(
    ...
    return await methodChannel.invokeMethod<bool>('create', {
          ...
          "useTopLevelWindowHost": useTopLevelWindowHost,
        }) ??
        false;
  }
