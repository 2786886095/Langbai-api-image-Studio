...
class WinWebViewController {
  ...
  void Function(Object? message)? onWebMessageReceived;
  void Function(int kind)? onProcessFailed;
  ...
  void notifyRawWebMessage_(Object? message) {
  ...
  void notifyOnProcessFailed_(int kind) {
    onProcessFailed?.call(kind);
  }
