  ...
  test('only this repository GitHub release assets are trusted for updates',
    ...
    expect(
      isTrustedReleaseAssetUrl(
        'https://github.com/2786886095/Langbai-api-image-Studio/releases/download/v1.3.17/AI-Image-Generator-Setup.exe',
      ),
      isTrue,
    );
    expect(
    ...
    expect(
      isTrustedReleaseAssetUrl(
        'http://github.com/2786886095/Langbai-api-image-Studio/releases/download/v1.3.17/Setup.exe',
      ),
      isFalse,
    );
    expect(
