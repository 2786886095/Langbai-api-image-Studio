...
assert.match(embeddedGatewayImageTasks, /min\(3, max_concurrency\)/);
...
assert.match(codexImageGateway, /CLIENT_MAX_CONCURRENCY\s*=\s*3/);
assert.match(codexImageGateway, /clientQueue:\s*3/);
assert.match(html, /id="codexGatewayClientQueue"[^>]*max="3"[^>]*value="3"/);
