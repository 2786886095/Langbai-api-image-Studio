...
const releaseNotes = read("RELEASE_NOTES_v1.7.0.md");
...
const expectedCacheToken = "20260909-1-7-0";
const expectedSwCache = "ai-image-generator-1-7-0-20260909-studio";
...
assert.match(html, /20260909-1-7-0/g);
assert.match(sw, /ai-image-generator-1-7-0-20260909/);
...
assert.match(runnerRc, /VERSION_AS_NUMBER 1,7,0,113/);
assert.match(runnerRc, /VERSION_AS_STRING "1\.7\.0"/);
assert.match(workflow, /const APP_VERSION = "1\.7\.0";/);
assert.match(workflow, /bootstrap-guard\.js\\\?v=20260909-1-7-0/);
