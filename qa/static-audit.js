...
const expectedCacheToken = "20260811-1-6-32";
const expectedSwCache = "ai-image-generator-1-6-32-20260811";
...
assert.match(html, /v1\.6\.32/);
assert.match(html, /20260811-1-6-32/g);
assert.match(sw, /ai-image-generator-1-6-32-20260811/);
...
assert.match(runnerRc, /VERSION_AS_NUMBER 1,6,32,109/);
assert.match(runnerRc, /VERSION_AS_STRING "1\.6\.32"/);
assert.match(workflow, /const APP_VERSION = "1\.6\.32";/);
assert.match(workflow, /bootstrap-guard\.js\\\?v=20260811-1-6-32/);
