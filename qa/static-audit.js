...
const expectedCacheToken = "20260804-1-6-28";
const expectedSwCache = "ai-image-generator-1-6-28-20260804";
...
assert.match(html, /v1\.6\.28/);
assert.match(html, /20260804-1-6-28/g);
assert.match(sw, /ai-image-generator-1-6-28-20260804/);
...
assert.match(runnerRc, /VERSION_AS_NUMBER 1,6,28,105/);
assert.match(runnerRc, /VERSION_AS_STRING "1\.6\.28"/);
assert.match(workflow, /const APP_VERSION = "1\.6\.28";/);
assert.match(workflow, /bootstrap-guard\.js\\\?v=20260804-1-6-28/);
