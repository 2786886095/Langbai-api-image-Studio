...
const expectedCacheToken = "20260803-1-6-26";
const expectedSwCache = "ai-image-generator-1-6-26-20260803";
...
assert.match(html, /v1\.6\.26/);
assert.match(html, /20260803-1-6-26/g);
assert.match(sw, /ai-image-generator-1-6-26-20260803/);
...
assert.match(runnerRc, /VERSION_AS_NUMBER 1,6,26,103/);
assert.match(runnerRc, /VERSION_AS_STRING "1\.6\.26"/);
assert.match(workflow, /const APP_VERSION = "1\.6\.26";/);
assert.match(workflow, /bootstrap-guard\.js\\\?v=20260803-1-6-26/);
