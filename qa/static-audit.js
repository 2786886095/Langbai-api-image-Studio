...
const expectedVersion = "1.6.34";
const expectedBuild = 111;
const expectedCacheToken = "20260812-1-6-34";
const expectedSwCache = "ai-image-generator-1-6-34-20260812";
...
assert.match(html, /v1\.6\.34/);
assert.match(html, /20260812-1-6-34/g);
assert.match(sw, /ai-image-generator-1-6-34-20260812/);
...
assert.match(runnerRc, /VERSION_AS_NUMBER 1,6,34,111/);
assert.match(runnerRc, /VERSION_AS_STRING "1\.6\.34"/);
assert.match(workflow, /const APP_VERSION = "1\.6\.34";/);
assert.match(workflow, /bootstrap-guard\.js\\\?v=20260812-1-6-34/);
