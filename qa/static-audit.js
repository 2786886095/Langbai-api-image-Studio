...
const expectedVersion = "1.6.35";
const expectedBuild = 112;
const expectedCacheToken = "20260909-1-6-35";
const expectedSwCache = "ai-image-generator-1-6-35-20260909";
...
assert.match(html, /v1\.6\.35/);
assert.match(html, /20260909-1-6-35/g);
assert.match(sw, /ai-image-generator-1-6-35-20260909/);
...
assert.match(runnerRc, /VERSION_AS_NUMBER 1,6,35,112/);
assert.match(runnerRc, /VERSION_AS_STRING "1\.6\.35"/);
assert.match(workflow, /const APP_VERSION = "1\.6\.35";/);
assert.match(workflow, /bootstrap-guard\.js\\\?v=20260909-1-6-35/);
